...
export const Sidebar = () => {
  return (
    <div className="z-20">
      ...
      <div className="fixed top-0 left-0 w-screen h-screen backdrop-blur-[2px]" />

      <nav className="fixed right-0 top-0 w-96 h-screen bg-background border-l border-neutral-700 shadow-xl shadow-black transform transition-all duration-300">
